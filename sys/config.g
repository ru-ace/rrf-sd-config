...
M906 X580 Y580 Z580 E700 I30           			; set motor currents (mA) and motor idle factor in per cent
M84 S30                                        	; Set idle timeout

; Axis Limits
M208 X0 Y0 Z0 S1                          		; set axis minima
M208 X235 Y209 Z250 S0                    		; set axis maxima
...
; Z-Probe
;BFPTouch
M950 S0 C"servo0"								; define servo
M280 P0 S50										; retract probe
M558 P5 H6 F120 T8000 C"^probe"  				; enable Z probe but set dive height, probe speed and travel speed
G31 P1000 X-41 Y-9 Z1.27						; probe offsets

; Heaters
M308 S0 P"bedtemp" Y"thermistor" T100000 B4092 	; configure sensor 0 as thermistor on pin bedtemp
M950 H0 C"bed" T0                              	; create bed heater output on bed and map it to sensor 0
;M307 H0 B0 S1.00                               	; disable bang-bang mode for the bed heater and set PWM limit
M307 H0 B0 R0.354 C562.0 D2.52 S1.00 V24.0
M140 H0                                        	; map heated bed to heater 0
M143 H0 S120                                   	; set temperature limit for heater 0 to 120C
M308 S1 P"e0temp" Y"thermistor" T100000 B4092  	; configure sensor 1 as thermistor on pin e0temp
M950 H1 C"e0heat" T1                           	; create nozzle heater output on e0heat and map it to sensor 1
;M307 H1 B0 S1.00                               	; disable bang-bang mode for heater  and set PWM limit
M307 H1 B0 R2.723 C156.7:144.2 D7.37 S1.00 V24.0
M143 H1 S245                                   	; set temperature limit for heater 1 to 280C

; Fans
M950 F0 C"fan0" Q500                         	; create fan 1 on pin out4 and set its frequency
M106 P0 C"Model" S0 H-1              ; set fan 1 value. Thermostatic control is turned off
M950 F1 C"fan1" Q500                           	; create fan 0 on pin fan0 and set its frequency
M106 P1 C"Board" S127 H-1                   ; set fan 0 value. Thermostatic control is turned off
